      ...
      <div className="hidden md:flex flex-1 relative items-center justify-center p-6">
        ...
        <div className="z-10">
          ...
          <div className="font-light text-slate-400 mt-4">
            Yaralanmalı trafik kazası sonucu kişinin bedenen iş gücü kaybına
            uğraması durumunda malul kaldığı oran, bakiye ömür, kusur ve aldığı
            ücret nispetinde aldığı tazminata Maluliyet Tazminatı denilmektedir.
            Maluliyet tazminatı sakatlık tazminatı olarak da bilinmektedir.
          </div>
        </div>
      </div>
    </div>
